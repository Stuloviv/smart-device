...
var navigationElement = document.querySelector('.footer__site-navigation');
...
/* harmony import */ var _footer_accordion_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./footer-accordion.js */ "./js/footer-accordion.js");
/* harmony import */ var _footer_accordion_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_footer_accordion_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _open_about_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./open-about.js */ "./js/open-about.js");
/* harmony import */ var _open_about_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_open_about_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _open_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./open-modal.js */ "./js/open-modal.js");
/* harmony import */ var _phone_validation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./phone-validation.js */ "./js/phone-validation.js");
/* harmony import */ var _phone_validation_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_phone_validation_js__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form-validate/form */ "./js/modules/form-validate/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_6__["Form"]();
    window.form = form;
    form.init();
  });
});
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    Object(_phone_mask__WEBPACK_IMPORTED_MODULE_7__["initPhoneMask"])();
  });
});
...
var detailedToggle = document.querySelector('.about__button');
var aboutElement = document.querySelector('.about__text-wrapper');
...
var modalContainerElement = document.querySelector('.modal-container');
var headerCallbackElement = document.querySelector('.header__callback-button');
var closeButtonElement = modalContainerElement.querySelector('.modal__close-button');
var modalNameFieldElement = document.getElementById('user-name-modal');
window.focusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_0__["FocusLock"]();
window.scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["ScrollLock"]();
var isEscapeDown = function isEscapeDown(evt) {
  if (evt.key === 'Escape') {
    evt.preventDefault();
...
var modalClose = function modalClose() {
  ...
  modalContainerElement.addEventListener('click', function (evt) {
...
var phoneElements = document.querySelectorAll('input[type="tel"]');
var buttonElements = document.querySelectorAll('button[type="submit"]');
var PHONE_NUMBER_LENGTH_WITH_MASK = 18;
phoneElements.forEach(function (phoneElement) {
  phoneElement.addEventListener('keydown', function () {
